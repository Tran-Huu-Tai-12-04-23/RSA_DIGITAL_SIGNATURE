...
public class RSAbasic {
    ...
    public static void main(String[] args) {
        ...
        // Mã hóa một số nguyên sử dụng khóa công khai
        BigInteger plaintext = new BigInteger("123456789");
        BigInteger ciphertext = plaintext.modPow(public_key[1], public_key[0]);
        System.out.println("Ciphertext: " + ciphertext);

        // Giải mã số nguyên đã được mã hóa sử dụng khóa bí mật
        plaintext = ciphertext.modPow(private_key[1], private_key[0]);
